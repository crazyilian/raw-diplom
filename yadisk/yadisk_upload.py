...
def main() -> None:
    ...
    parser.add_argument("--overwrite-different-size", action="store_true", help="Overwrite remote files when the md5 is different")
    ...
    sync_upload_dir(client, local_root, remote_root, args.overwrite_different_size)
