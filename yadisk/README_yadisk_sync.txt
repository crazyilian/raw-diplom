...
- на Яндекс Диске все zip-файлы хранятся как *.zipfast (так загрузка и скачиваение работают быстрее, потому что Яндекс Диск выключает дополнительные проверки архива);
...
- для download схожая логика: если всё в subtree кроме plots/ уже синхронизировано и локальный plots/ существует, то download считает plots синхронизированным и не скачивает
